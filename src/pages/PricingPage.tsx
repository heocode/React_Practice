  ...
  return (
    <div className="bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 pt-24">
      ...
      <section className="relative py-20 text-center overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-purple-500/8 dark:bg-purple-500/12 rounded-full blur-3xl pointer-events-none" />
          ...
          {plans.map(plan => (
            ...
            >
              ...
              {plan.ctaTo.startsWith('mailto') ? (
                <a
                  href={plan.ctaTo}
                  className={`w-full text-center py-2.5 rounded-xl text-sm font-medium transition-colors mb-8 ${
                    plan.highlight
