    ...
    return (
        <div className="h-dvh bg-white dark:bg-zinc-950 flex items-center justify-center px-4 pt-16" onClick={handleClose}>
            ...
            <div className="relative w-full max-w-sm" onClick={e => e.stopPropagation()}>
                <div className="relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 md:p-8 shadow-xl shadow-zinc-200/50 dark:shadow-zinc-900/50">
                    <button
                        onClick={handleClose}
                    ...
                    <p className="text-sm text-center text-zinc-500 dark:text-zinc-400 mb-4 md:mb-6">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-zinc-300 dark:border-zinc-700 rounded-xl text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-3 md:mb-5"
                    >
                        {googleLoading ? (
                    ...
                    <p className="mt-3 md:mt-5 text-sm text-center text-zinc-500 dark:text-zinc-400">
